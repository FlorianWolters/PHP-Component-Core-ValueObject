...
Contributions to **FlorianWolters\Component\Core\ValueObject** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Core\ValueObject**:

    md ValueObject && cd ValueObject
    git clone git://github.com/FlorianWolters/PHP-Component-Core-ValueObject.git
